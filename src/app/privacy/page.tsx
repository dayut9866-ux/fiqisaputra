...
import { ArrowLeft, Shield, FileText, Home } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Memuat kebijakan privasi...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-gray-800">Kebijakan Privasi</span>
              </div>
            </div>
            <Button 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8 border-orange-200 bg-white/80 backdrop-blur">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-xl text-gray-600 mt-2">{privacyData.companyName}</p>
              <p className="text-sm text-gray-500">Terakhir diperbarui: {privacyData.lastUpdated}</p>
            </CardHeader>
          </Card>
      ...
      <footer className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-8 px-4 mt-16">
        <div className="container mx-auto text-center">
          <p className="text-orange-100 mb-2">
            © 2024 {privacyData.companyName}. Hak Cipta Dilindungi.
          </p>
          <p className="text-orange-200 text-sm">
            Kebijakan Privasi ini berlaku untuk semua layanan yang kami sediakan.
          </p>
        </div>
      </footer>
    </div>
